...
public class VillagerNPC extends NPC{
    ...
    public VillagerNPC(String name, String skin, JSONArray text, String location) {
        super(name, skin, text, location);
    }

    public VillagerNPC(String name, String skin, JSONArray text, String location, JSONObject json) {
    ...
    public void spawn(){
        ...
        villager = VillagerNMS.spawnVillager(getLocation());
        villager.setProfession(Villager.Profession.valueOf(getSkin()));
